...
import { 
  History, RefreshCw, ArrowLeft, ArrowRight, 
  Settings, User, Brain, AlertCircle 
} from 'lucide-react';
                ...
                : (
                  <tr>
                    <td colSpan={5} className="py-32">
                      <EmptyState message="No se han registrado acciones de auditoría en la base de datos central." />
                    </td>
                  </tr>
                )}
            </tbody>
